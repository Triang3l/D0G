...
protected:
	...
	virtual WIN32_FIND_HANDLE FS_FindFirstFile(const char *findname, WIN32_FIND_DATA *dat);
	virtual bool FS_FindNextFile(WIN32_FIND_HANDLE handle, WIN32_FIND_DATA *dat);
	virtual bool FS_FindClose(WIN32_FIND_HANDLE handle);
...
// Purpose: low-level filesystem wrapper
//-----------------------------------------------------------------------------
WIN32_FIND_HANDLE CFileSystem_Stdio::FS_FindFirstFile(const char *findname, WIN32_FIND_DATA *dat)
{
...
// Purpose: low-level filesystem wrapper
//-----------------------------------------------------------------------------
bool CFileSystem_Stdio::FS_FindNextFile(WIN32_FIND_HANDLE handle, WIN32_FIND_DATA *dat)
{
...
// Purpose: low-level filesystem wrapper
//-----------------------------------------------------------------------------
bool CFileSystem_Stdio::FS_FindClose(WIN32_FIND_HANDLE handle)
{
