...
#if defined( __i386__ ) || defined( _X360 )
...
#elif defined( __ARM_NEON__ )
	// Replicate scalar float out to 4 components
	float32x4_t packed = vdupq_n_f32( w );

	// 4D NEON Vector MAD
	vOutA.AsM128() = vmlaq_f32( vOutA.AsM128(), vInA.AsM128(), packed );
	vOutB.AsM128() = vmlaq_f32( vOutB.AsM128(), vInB.AsM128(), packed );
#else
