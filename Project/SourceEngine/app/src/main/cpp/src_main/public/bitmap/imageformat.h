...
enum ImageFormat 
{
	...
	IMAGE_FORMAT_GLES_D16_NONLINEAR_TEX, // NV_depth_nonlinear + OES_depth_texture
	IMAGE_FORMAT_GLES_D24_RB, // OES_depth24
	IMAGE_FORMAT_GLES_D24_TEX, // OES_depth24 + OES_depth_texture
	IMAGE_FORMAT_GLES_DST24_RB, // OES_packed_depth_stencil
	IMAGE_FORMAT_GLES_DST24_TEX // OES_packed_depth_stencil + OES_depth_texture
#endif
