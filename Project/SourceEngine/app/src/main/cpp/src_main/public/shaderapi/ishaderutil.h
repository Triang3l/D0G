...
#ifdef SHADERAPI_GLES2
#define SHADER_UTIL_INTERFACE_VERSION "VShaderUtil001_ShaderSourceProvider001"
#else
...
#ifdef SHADERAPI_GLES2
	virtual IShaderSourceProvider *FindShaderSourceProvider( IShaderSourceProvider::ShaderStage_t stage,
	                                                         const char *pProviderName ) = 0;
#endif
};
