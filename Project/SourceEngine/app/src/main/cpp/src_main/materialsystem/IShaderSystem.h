...
//-----------------------------------------------------------------------------
#ifdef SHADERAPI_GLES2
#define SHADER_DLL_INTERFACE_VERSION	"ShaderDLL004_ShaderSourceProvider001"
#else
...
#ifdef SHADERAPI_GLES2
	// Returns the number of shader source providers defined in this DLL
	virtual int ShaderSourceProviderCount( IShaderSourceProvider::ShaderStage_t stage ) const = 0;

	// Returns source provider defined in this DLL
	virtual IShaderSourceProvider *GetShaderSourceProvider( IShaderSourceProvider::ShaderStage_t stage, int nShader ) const = 0;
#endif
};
