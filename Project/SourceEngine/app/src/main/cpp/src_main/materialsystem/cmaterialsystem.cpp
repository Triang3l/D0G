...
IShaderSourceProvider *CMaterialSystem::FindShaderSourceProvider( IShaderSourceProvider::ShaderStage_t stage,
                                                                  const char *pProviderName )
{
	return ShaderSystem()->FindShaderSourceProvider( stage, pProviderName );
}
#endif
